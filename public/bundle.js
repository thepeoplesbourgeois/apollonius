...
var pixiedust = fn => augmentor(function () {
...
const App = pixiedust(() => {
  ...
  const ErrorMessage = pixiedust(() => html$1`<div style=${{
      ...
      <div>
        ...
        <div>
          <table>
            ...
            <tbody>
              ${Object.entries(metaRest).map(([key, value]) => html$1`
                <tr>
                  <td>${key}</td>
                  <td>${value}</td>
                </tr>
  ...
  const VideoPlayer = pixiedust(() => html$1`
    <div style=${{
      display: 'flex',
      flexDirection: 'row',
    }}>
